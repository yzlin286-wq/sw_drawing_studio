...
| `post_saveas_reopen_prune_after` | `11` | `warnings.reference_dim_prune.prune.after` |
...
| `post_layout_final` | `18` | `warnings.post_layout_dim_repair.after` |
| `dimension_validation_final` | `24` | `dimension_validation.display_dim_count` |

## Loss Events

- `post_saveas_reopen_prune_before` -> `post_saveas_reopen_prune_after`: 15 -> 11 (lost 4)
