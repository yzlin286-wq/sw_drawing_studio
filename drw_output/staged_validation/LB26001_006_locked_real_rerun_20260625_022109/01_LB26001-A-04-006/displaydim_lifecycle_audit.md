...
| `pre_export_final` | `19` | `warnings.display_dim_count_final` |
...
| `dimension_validation_final` | `19` | `dimension_validation.display_dim_count` |
...
- `pre_export_final` -> `post_layout_before_repair`: 19 -> 12 (lost 7)
