...
| `pre_export_final` | `16` | `warnings.display_dim_count_final` |
...
| `dimension_validation_final` | `16` | `dimension_validation.display_dim_count` |
...
- `pre_export_final` -> `post_layout_before_repair`: 16 -> 12 (lost 4)
...
- Missing post-layout targets: `hole_diameter`
