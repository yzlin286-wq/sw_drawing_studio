...
| `pre_export_final` | `17` | `warnings.display_dim_count_final` |
...
| `dimension_validation_final` | `17` | `dimension_validation.display_dim_count` |
...
- `pre_export_final` -> `post_layout_before_repair`: 17 -> 12 (lost 5)
...
- Deleted target keys: `overall_width, right_end_offset, left_end_offset, projection_view_width, hole_y_location`
...
- Missing post-layout targets: `overall_height, hole_diameter`
- Incomplete target traces: `overall_length, overall_width, left_end_offset, hole_x_location, hole_y_location, hole_pitch, projection_view_width, small_feature_location`
...
| `overall_width` | `top` | `AddVerticalDimension2` | `none` | `none` | `false` |
| `overall_height` | `right` | `AddVerticalDimension2` | `post_layout_final` | `none` | `true` |
| `left_end_offset` | `top` | `AddHorizontalDimension2` | `none` | `none` | `false` |
| `right_end_offset` | `top` | `AddHorizontalDimension2` | `none` | `none` | `true` |
| `hole_diameter` | `top` | `AddDiameterDimension2` | `post_layout_final` | `none` | `true` |
