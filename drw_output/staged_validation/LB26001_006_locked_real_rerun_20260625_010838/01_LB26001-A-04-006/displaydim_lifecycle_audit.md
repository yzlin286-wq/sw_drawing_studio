...
| `post_layout_explicit_after` | `12` | `warnings.post_layout_dim_repair.explicit_display_dims.after` |
| `post_layout_final` | `12` | `warnings.post_layout_dim_repair.after` |
...
- `before_sidecar_diagnostic` -> `pre_export_final`: 12 -> 11 (lost 1)
- `post_layout_final` -> `dimension_validation_final`: 12 -> 11 (lost 1)
...
- Live view recovery failed: `true`
- Current doc view count: `0`
...
- Missing post-layout targets: `right_end_offset, hole_diameter, hole_pitch, projection_view_height`
...
| --- | --- | --- | --- | --- | --- |
| `overall_length` | `front` | `AddHorizontalDimension2` | `none` | `post_layout_live_view_recovery_failed` | `false` |
| `overall_width` | `top` | `AddVerticalDimension2` | `post_saveas_reopen_prune` | `post_layout_live_view_recovery_failed` | `false` |
| `overall_height` | `right` | `AddVerticalDimension2` | `post_saveas_reopen_prune_guard` | `post_layout_live_view_recovery_failed` | `false` |
| `left_end_offset` | `top` | `AddHorizontalDimension2` | `none` | `post_layout_live_view_recovery_failed` | `false` |
| `right_end_offset` | `top` | `AddHorizontalDimension2` | `post_layout_final` | `post_layout_live_view_recovery_failed` | `false` |
| `hole_diameter` | `top` | `AddDiameterDimension2` | `post_saveas_reopen_prune_guard` | `post_layout_live_view_recovery_failed` | `false` |
| `hole_x_location` | `top` | `AddHorizontalDimension2` | `none` | `post_layout_live_view_recovery_failed` | `false` |
| `hole_y_location` | `top` | `AddVerticalDimension2` | `none` | `post_layout_live_view_recovery_failed` | `false` |
| `hole_pitch` | `top` | `AddHorizontalDimension2` | `post_layout_final` | `post_layout_live_view_recovery_failed` | `false` |
| `projection_view_width` | `right` | `AddHorizontalDimension2` | `none` | `post_layout_live_view_recovery_failed` | `false` |
| `projection_view_height` | `right` | `AddVerticalDimension2` | `post_saveas_reopen_prune_guard` | `post_layout_live_view_recovery_failed` | `false` |
| `small_feature_location` | `right` | `AddVerticalDimension2` | `none` | `post_layout_live_view_recovery_failed` | `false` |
