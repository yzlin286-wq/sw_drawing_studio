...
| `post_saveas_reopen_prune_after` | `15` | `warnings.reference_dim_prune.prune.after_restored` |
...
| `pre_export_final` | `24` | `warnings.display_dim_count_final` |
| `post_layout_before_repair` | `12` | `warnings.post_layout_dim_repair.before` |
| `post_layout_explicit_after` | `18` | `warnings.post_layout_dim_repair.explicit_display_dims.after` |
| `post_layout_final_exact_prune_before` | `24` | `warnings.post_layout_dim_repair.post_layout_final_exact_prune_display_dim_count_before` |
| `post_layout_final_exact_prune_after` | `24` | `warnings.post_layout_dim_repair.post_layout_final_exact_prune_display_dim_count_after` |
| `post_layout_final` | `24` | `warnings.post_layout_dim_repair.after` |
| `dimension_validation_final` | `24` | `dimension_validation.display_dim_count` |

## Loss Events

- `post_saveas_reopen_prune_after` -> `post_prune_guard_before`: 15 -> 12 (lost 3)
- `pre_export_final` -> `post_layout_before_repair`: 24 -> 12 (lost 12)
...
- Deleted target keys: `overall_width, overall_height, overall_length, left_end_offset, projection_view_width, small_feature_location, hole_pitch, hole_x_location`
