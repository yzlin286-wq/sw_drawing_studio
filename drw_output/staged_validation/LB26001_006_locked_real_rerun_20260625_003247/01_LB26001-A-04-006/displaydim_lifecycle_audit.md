...
- Incomplete target traces: `overall_length, overall_height, left_end_offset, right_end_offset, hole_diameter, hole_x_location, hole_y_location, hole_pitch, projection_view_width, projection_view_height, small_feature_location`
...
| `overall_width` | `top` | `AddVerticalDimension2` | `post_saveas_reopen_prune` | `none` | `true` |
| `overall_height` | `right` | `AddVerticalDimension2` | `post_saveas_reopen_prune_guard` | `none` | `false` |
| `left_end_offset` | `top` | `AddHorizontalDimension2` | `none` | `none` | `false` |
| `right_end_offset` | `top` | `AddHorizontalDimension2` | `post_layout_final` | `target_view_not_found` | `false` |
| `hole_diameter` | `top` | `AddDiameterDimension2` | `post_saveas_reopen_prune_guard` | `target_view_not_found` | `false` |
| `hole_x_location` | `top` | `AddHorizontalDimension2` | `none` | `none` | `false` |
| `hole_y_location` | `top` | `AddVerticalDimension2` | `none` | `none` | `false` |
| `hole_pitch` | `top` | `AddHorizontalDimension2` | `post_layout_final` | `target_view_not_found` | `false` |
| `projection_view_width` | `right` | `AddHorizontalDimension2` | `none` | `none` | `false` |
| `projection_view_height` | `right` | `AddVerticalDimension2` | `post_saveas_reopen_prune_guard` | `target_view_not_found` | `false` |
